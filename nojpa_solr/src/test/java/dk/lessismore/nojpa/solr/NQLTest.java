...
public class NQLTest {
    ...
    public void testBig10() {
        SolrServiceImpl solrService = null;
...
//
//        ModelObjectSearchService.addSolrServer(Address.class, solrService.getServerClient());
//
//
...
//        solrService.getServerClient();
//        SolrSearchQuery solrSearchQuery = new SolrSearchQuery(Address.class);
//        solrSearchQuery.getSolrQuery().setQuery("*:*");
//        QueryResponse response = solrService.query(solrSearchQuery);
...
//
//            {
//                SolrSearchQuery searchQuery = new SolrSearchQuery(Person.class);
//                SolrQuery query = searchQuery.getSolrQuery();
//                query.setQuery("*:*");
//                query.setFacet(true);
...
//
//                QueryResponse response = solrService.query(searchQuery);
//
