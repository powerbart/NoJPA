...
//         * @return this
//         */
//        public SearchQuery<T> where(int mockValue, Comp comp, int value) {
//            rootConstraints.add(has(mockValue, comp, value));
//            return this;
//        }
//
//        public SearchQuery<T> where(boolean mockValue, Comp comp, boolean value) {
//            rootConstraints.add(has(mockValue, comp, value));
//            return this;
//        }
//
//        public SearchQuery<T> where(String mockValue, Comp comp, String value) {
//            rootConstraints.add(has(mockValue, comp, value));
//            return this;
//        }
//
//        public SearchQuery<T> where(Enum mockValue, Comp comp, Enum value) {
//            rootConstraints.add(has(mockValue, comp, value));
//            return this;
//        }
//
...
//        }
//
//        public SearchQuery<T> where(Calendar mockValue, Comp comp, Calendar value) {
//            rootConstraints.add(has(mockValue, comp, value));
//            return this;
//        }
//
//        public SearchQuery<T> where(double mockValue, Comp comp, double value) {
//            rootConstraints.add(has(mockValue, comp, value));
//            return this;
//        }
//        public <M extends ModelObjectInterface> SearchQuery<T> where(M mockValue, Comp comp, M model) {
//            rootConstraints.add(has(mockValue, comp, model));
//            return this;
//        }
//
//        public SearchQuery<T> where(Constraint constraint) {
//            rootConstraints.add(constraint);
//            return this;
//        }
//
//        public SearchQuery<T> whereIsNull(Calendar mockValue) {
//            List<Pair<Class, String>> joints = getJoinsByMockCallSequence();
//            Pair<Class, String> pair = getSourceAttributePair();
//            clearMockCallSequence();
//            String attribute = makeAttributeIdentifier(pair);
...
//        }
//
//        public SearchQuery<T> whereIsNotNull(Calendar mockValue) {
//            List<Pair<Class, String>> joints = getJoinsByMockCallSequence();
//            Pair<Class, String> pair = getSourceAttributePair();
//            clearMockCallSequence();
//            String attribute = makeAttributeIdentifier(pair);
...
//        }
//
//        public <M extends ModelObjectInterface> SearchQuery<T> whereIsNull(M mockValue) {
//            List<Pair<Class, String>> joints = getJoinsByMockCallSequence();
//            Pair<Class, String> pair = getSourceAttributePair();
//            clearMockCallSequence();
//            String attribute = makeAttributeIdentifier(pair);
...
//        }
//
//        public <M extends ModelObjectInterface> SearchQuery<T> whereIsNotNull(M mockValue) {
//            List<Pair<Class, String>> joints = getJoinsByMockCallSequence();
//            Pair<Class, String> pair = getSourceAttributePair();
//            clearMockCallSequence();
//            String attribute = makeAttributeIdentifier(pair);
...
//        }
//
//        public SearchQuery<T> whereIsNull(String mockValue) {
//            List<Pair<Class, String>> joints = getJoinsByMockCallSequence();
//            Pair<Class, String> pair = getSourceAttributePair();
//            clearMockCallSequence();
//            String attribute = makeAttributeIdentifier(pair);
...
//        }
//
//        public SearchQuery<T> whereIsNotNull(String mockValue) {
//            List<Pair<Class, String>> joints = getJoinsByMockCallSequence();
//            Pair<Class, String> pair = getSourceAttributePair();
//            clearMockCallSequence();
//            String attribute = makeAttributeIdentifier(pair);
