...
import dk.lessismore.reusable_v4.masterworker.bean.client.JobListener;
import dk.lessismore.reusable_v4.masterworker.bean.client.JobHandle;
import dk.lessismore.reusable_v4.masterworker.bean.client.MasterService;
