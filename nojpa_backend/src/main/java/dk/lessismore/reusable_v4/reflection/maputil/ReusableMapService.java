package dk.lessismore.reusable_v4.reflection.maputil;
...
import dk.lessismore.reusable_v4.reflection.attributes.AttributeContainer;
import dk.lessismore.reusable_v4.reflection.attributes.Attribute;
import dk.lessismore.reusable_v4.reflection.ClassReflector;
...
public class ReusableMapService {
    ...
    public static <R extends ModelObjectInterface> R createOrUpdate(Class<R> sourceClass, Map<String, String> attNameAndAttValue){
        ...
        if(objectID == null){
            ...
            toReturn = MQ.selectByID(sourceClass, objectID);
        }
