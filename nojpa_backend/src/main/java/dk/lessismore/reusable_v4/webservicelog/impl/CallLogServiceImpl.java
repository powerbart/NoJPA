...
import dk.lessismore.reusable_v4.file.Files;
...
import dk.lessismore.reusable_v4.db.LimResultSet;
...
import dk.lessismore.reusable_v4.resources.PropertyService;
import dk.lessismore.reusable_v4.webservicelog.CallerIdentifierLog;
import dk.lessismore.reusable_v4.webservicelog.CallLog;
import dk.lessismore.reusable_v4.webservicelog.CallLogService;
...
public class CallLogServiceImpl implements CallLogService {
    ...
    public CallLog getCallLogByID(String id, CallerIdentifierLog callerIdentifierLog) {
        return MQ.selectByID(CallLog.class, id);
    }
    ...
    */
    ...
    public int removeCallLogsFromBefore(Calendar calendar, CallerIdentifierLog callerIdentifierLog) {
        ...
        int count = 0;
        while(true) {
            CallLog mock = MQ.mock(CallLog.class);
            List<CallLog> result = MQ.select(mock).where(mock.getCreationDate(), MQ.Comp.LESS, calendar).getList();
