package dk.lessismore.reusable_v4.file;
...
public final class Files {
    ...
    public static File createTemporaryDirectory(String prefix) {
        try {
            ...
            if(!file.delete()) throw new FileException("Could not delete intermediate temporary file " + file);
            if(!file.mkdir()) throw new FileException("Could not create temporary directory " + file);
            file.deleteOnExit();
            return file;
        } catch(IOException e) {
            throw new FileException(e);
