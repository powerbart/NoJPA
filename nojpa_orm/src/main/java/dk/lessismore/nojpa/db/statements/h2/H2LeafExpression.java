 ...
 * @version 1.0 25-7-02
 */
public class H2LeafExpression implements LeafExpression {
    ...
    public LeafExpression addConstrain(String attributeName, int comparator, String value) {
        statement = attributeName + " " + WhereSQLStatement.comparatorAsStr[comparator] + " " + H2Util.convertToSql(value);
        preparedStatement = attributeName + " " + WhereSQLStatement.comparatorAsStr[comparator] + " ?";
        preparedValue = H2Util.convertToPreparedSql(value);
        return this;
    }
