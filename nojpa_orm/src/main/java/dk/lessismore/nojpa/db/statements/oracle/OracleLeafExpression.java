 ...
 * @version 1.0 25-7-02
 */
public class OracleLeafExpression implements LeafExpression {
    ...
    public LeafExpression addConstrain(String attributeName, int comparator, String value) {
        statement = attributeName + " " + WhereSQLStatement.comparatorAsStr[comparator] + " " + OracleUtil.convertToSql(value);
        preparedStatement = attributeName + " " + WhereSQLStatement.comparatorAsStr[comparator] + " ?";
        preparedValue = OracleUtil.convertToPreparedSql(value);
        return this;
    }
