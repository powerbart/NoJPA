 ...
 * @version 1.0 25-7-02
 */
public class OracleWhereStatement extends OracleStatement implements WhereSQLStatement {

    private final static Logger log = Logger.getLogger(OracleWhereStatement.class);

    protected ContainerExpression basicContainerExpression = new OracleContainerExpression();
    protected ContainerExpression containerExpression = new OracleContainerExpression();
    protected List constrains = null;

    public OracleWhereStatement() {
    ...
    public void addJoin(String attributeName1, String attributeName2) {
        LeafExpression leafExpression = new OracleLeafExpression();
...
//        log.debug("makeStatement():1");
        ...
        ContainerExpression pt = new OracleContainerExpression();
