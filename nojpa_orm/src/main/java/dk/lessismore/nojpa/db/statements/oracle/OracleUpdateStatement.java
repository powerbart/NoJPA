...
public class OracleUpdateStatement extends OracleInsertStatement implements UpdateSQLStatement {
    ...
    OracleWhereStatement whereStatement = null;

    protected OracleWhereStatement getWhereStatement() {
        if (whereStatement == null) {
            whereStatement = new OracleWhereStatement();
        }
...
//    }
    ...
    public static void main(String[] args) {
        OracleUpdateStatement s = new OracleUpdateStatement();
        s.addTableName("skod");
