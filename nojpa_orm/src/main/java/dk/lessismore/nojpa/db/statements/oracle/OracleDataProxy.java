...
import dk.lessismore.nojpa.reflection.attributeconverters.IntegerConverter;
 ...
 * User: seb
 */
public class OracleDataProxy implements OracleDataProxyInterface, InvocationHandler {

    private transient static final org.apache.log4j.Logger log = Logger.getLogger(OracleDataProxy.class);
    ...
    public static <T> T create(Class<T> interfaceClass) {
        OracleDataProxy object = new OracleDataProxy(interfaceClass);
        object.proxyObject = Proxy.newProxyInstance(
                interfaceClass.getClassLoader(),
                new Class<?>[]{interfaceClass, OracleDataProxyInterface.class},
                object);
    ...
    public void readRow(ResultSet rs, ResultSetMetaData metaData, Object objectToFill) throws Exception {
        ...
        for(int i = 1; i <= columnCount; i++){
            ...
            } catch (java.lang.NoSuchMethodException noExp){
...
//            setAssociationWithOutAnyFilters("" + object, name);
    ...
    protected Object clone() {
        try {
            OracleDataProxy c = (OracleDataProxy) OracleDataProxy.create(this.interfaceClass);
