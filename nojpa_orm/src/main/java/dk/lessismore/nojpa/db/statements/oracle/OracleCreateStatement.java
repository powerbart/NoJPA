 ...
 * @version 1.0 25-7-02
 */
public class OracleCreateStatement extends OracleStatement implements CreateSQLStatement {

    private final static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(OracleCreateStatement.class);
